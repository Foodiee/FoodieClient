@section('modal')
  <div class="modal fade modal-upload" tabindex="-1">
    <div class="modal-dialog" style="width:70%;">
      <div class="modal-content">
          ...
          <div id="board-choose-form" class="col-md-5 right-upload-modal">
            ...
            <div class="row board_choose " id="create_div" style="margin-top:30px;border-radius:6px;cursor:pointer">
              <img src="vendors/img/red-plus.png" width="50" height="50"> 
              <span style='margin-left:10px;'>Tạo thêm 1 bảng</span>
            </div>
          </div>
          <div id="board-create-form" class="col-md-5 right-upload-modal hidden">
             <div  class="row" style="margin-top:20px;">
              <h1>
              ...
              <div class="row board-edit-name">
                ...
                <br>
                <input id="boardname" name="boardname" class="board-name-input " placeholder="Nhập tên bảng"/>
              </div>
              <div class="row board-edit-name">
  ...
  <script>
    ...
    function changeClass(divNumber)
    {
      if(divNumber==1) 
        {
          $("#board-choose-form").removeClass("hidden");
          $("#board-create-form").addClass("hidden");
          // $("#board-choose-form").fadeIn();
          // $("#board-create-form").fadeOut();
        }
        else
        {
        // {
          $("#board-choose-form").addClass("hidden");
          $("#board-create-form").removeClass("hidden");
        // $("#board-choose-form").fadeIn();
        //   $("#board-create-form").fadeOut();
        }
    }
